...
class Register extends Component {
    render() {
        const isEnabled = this.props.state.newEmail.length > 0 && this.props.state.password1.length > 5 && this.props.state.password2.length > 5 && this.props.state.newRole !== "";
        ...
        return (
            <div>
                ...
                <div className="form-group">
                    ...
                    <small className={`d-block`}>{notEmailText}</small>
                </div>
                <div className="form-group">
                    ...
                    <small className={`d-block`}>{notPasswordTextLength}</small>
                    <small className={`d-block`}>{passwordsMatchText}</small>
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                    ...
                    <small className={`d-block`}>{roleSelectText}</small>
                </div>
